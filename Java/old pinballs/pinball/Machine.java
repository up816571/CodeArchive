...
public class Machine
{
    ...
    private ArrayList <PinballObject> pinballs = new ArrayList <PinballObject>();
    private ArrayList <Bumper> bumps = new ArrayList <Bumper>();
    ...
    */
    ...
    public ArrayList <PinballObject> getPinballs()
    {
        return pinballs;
    }
    
    public ArrayList <Bumper> getBumps()
    {
        return bumps;
    }
    ...
    public void runDemo()
    {
        for (PinballObject currentObject : getPinballs())
        {        
            currentObject.move();
        }
        for (Bumper currentObject : getBumps())
        {        
            currentObject.move();
        }
        for (Holes currentObject : getHoles())
        {
            currentObject.move();
        }
    }
